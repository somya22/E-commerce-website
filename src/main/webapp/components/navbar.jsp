...
<div class="container-fluid">
  <a class="navbar-brand" href="index.jsp"><h3>QuickCart</h3></a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0" action="ProductOperationServlet" method="post">
      ...
      <input class="form-control mr-sm-2" type="text" placeholder="Search product" aria-label="Search" size="30" name="search">
    ...
    <ul class="navbar-nav ml-auto">
       <li class="nav-item active">
        <div class="nav-link" data-toggle="modal" data-target=".forgetpasswordmodal"><b>Forgot password</b></div>
      </li> 
...
<style>
.nav-link {
  font-size: <%=(session.getAttribute("active-user") != null) ? "12px" : "16px"%> !important;
}
</style>
